...
<div class="sidebare">
        <div class="logo_content">
            <div class="logo">
                <div class="logo_name titulo-principal">USUARIO</div>
            </div>
        ...
        <ul class="nave">
            <li class="lis">
                <a class="as" href="#">
                    ...
                    <span class="nombre"><?php echo  $_SESSION['username'] ?> (Usuario)</span>
                </a>
                <span class="tooltip"></span>
            </li>
            <li class="lis">
                <a class="as" href="vistas_usuario.php">
                    <i class='bx bx-calendar-event is' ></i>
                    <span class="link_names">Vistas Usuarios</span>
                </a>
                <span class="tooltip">Vistas Usuarios</span>
            </li>
            <li class="lis">
                <a class="as" href="cerrar-sesion.php">
                    <i class='bx bxs-first-aid is' ></i>
    ...
    <div class="home_content">
        ...
        <h1 class="text-center titulo-principal">CONTENIDO DE USUARIO</h1>
        
        <div class="container table-responsive">
            <div class="img-titulo row g-4">
                <p class="alert alert-success">TU CONTENIDO</p>
                <!----AQUI PUEDES INGRESAR TU CONTENIDO DE USUARIO----->     
            </div>
...
<!------------------------MENSAJE DE EXITO DESPUES DE EDITAR-------------------------->
<!-------------------------------------------->
